...
<body>
    <div class="container">
        ...
        <div class="message">
            <h2>Welcome to Your Joint Account</h2>
            <p>Hello {{ $user->fullname }} and {{ $user->fullname2 }},</p>
            <p>We are excited to welcome you both to our platform. Thank you for choosing us for your financial needs.</p>
