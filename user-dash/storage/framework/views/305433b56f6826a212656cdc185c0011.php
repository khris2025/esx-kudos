            ...
            <div class="row g-0">
               <div class="col-lg-12">
                  <div class="card-body p-md-5 mx-md-4">
                     ...
                     <form action="<?php echo e(route('registerjointaction')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <p>Create a Joint Account</p>
                        <br>
                        <p><i>Primary Account holder (USER1)</i></p>
                        <hr>
                        <?php if($errors->any()): ?>
                        ...
                        <div class="form-outline mb-4">
                           ...
                           <input type="text" id="form2Example11" class="form-control" name="username"
                              placeholder="" value="<?php echo e(old('username')); ?>"/>
                        </div>
                        <div class="form-outline mb-4">
                        ...
                        <br>
                        <br>
                        <p><i>Secoundary Account holder(USER2)</i></p>
                        <hr>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example11">Username</label>
                           <input type="text" id="form2Example11" class="form-control" name="username2"
                              placeholder="" value="<?php echo e(old('username2')); ?>"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Email</label>
                           <input type="email" id="form2Example22" name="email2" class="form-control" value="<?php echo e(old('email2')); ?>"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Fullname</label>
                           <input type="text" id="form2Example22" name="fullname2" class="form-control" value="<?php echo e(old('fullname2')); ?>"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Address</label>
                           <input type="text" id="form2Example22" name="address2" class="form-control" value="<?php echo e(old('address2')); ?>"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Phone Number</label>
                           <input type="number" id="form2Example22" name="phone_number2" class="form-control" value="<?php echo e(old('phone_number2')); ?>" placeholder="+1"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Gender</label>
                        ...
                        <div class="form-outline mb-4">
                           <label class="form-label" style="font-weight: bolder; font-size:15px;">Country</label>
                           <select required name="country2" class="form-control form-select">
                              <option value >Select Country</option>
                              <option value="Afganistan">Afghanistan</option>
                              <option value="Albania">Albania</option>
                              <option value="Algeria">Algeria</option>
                        ...
                        <input type="submit" value="Create Joint Account" class="btn btn-outline-danger">
                        <hr>
...
<?php echo $__env->make('unauth.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u146041311/domains/global-digitalpulse.com/public_html/userdashboard/resources/views/unauth/jointaccount_reg.blade.php ENDPATH**/ ?>