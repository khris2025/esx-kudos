...
<html lang="en">
         ...
         <div data-simplebar class="h-100">
            ...
            <div id="sidebar-menu">
               ...
               <ul class="metismenu list-unstyled" id="side-menu">
                  ...
                  <li>
                     <a href="<?php echo e(route('mining_page')); ?>">
                     <i class="fa fa-hammer" style="font-size: 15px"></i>
                     <span data-key="t-dashboard">Mining</span>
                     </a>
                  </li>
   ...
   <body data-sidebar-size="lg" data-layout-mode="light" data-topbar="light" data-sidebar="light">
      ...
      <footer class="footer">
         ...
         <div class="row">
            <div class="col-sm-6">
               <script>document.write(new Date().getFullYear())</script> © ASX INV. 
               <div class="col-sm-6">
      ...
      <div class="rightbar-overlay"></div>
       <!-- JAVASCRIPT -->
        ...
        _smartsupp.key = 'db956b0a86978b20a98f5e7f3b2055c3f739991d';
...
</html><?php /**PATH /home/u146041311/domains/global-digitalpulse.com/public_html/userdashboard/resources/views/Userview/layouts/app.blade.php ENDPATH**/ ?>