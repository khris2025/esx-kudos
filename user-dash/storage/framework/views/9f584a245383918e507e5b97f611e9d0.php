                           ...
                           <div class="d-flex align-items-start mt-3 mt-sm-0">
                              ...
                              <div class="flex-grow-1">
                                 <div>
                                    ...
                                    <span class="text-muted font-size-13">Account Status: <?php echo e($user->account_status); ?></span>
                                    ...
                                    <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                       <div>
                                          ...
                                          <a class="btn btn-success waves-effect btn-label waves-light" href="<?php echo e(route('modify_profile_buttons', ['action' => 'account-status', 'id' => $user->id])); ?>"><i class="bx bx-user-check label-icon"></i>Active/Inactive</a>
                                      </div>                                      
                                    </div>
                                 </div>
                              </div>
...
<?php echo $__env->make('Adminview.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u146041311/domains/global-digitalpulse.com/public_html/userdashboard/resources/views/Adminview/user_modify.blade.php ENDPATH**/ ?>