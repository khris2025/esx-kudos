                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <h4 class="mb-3">$<span><?php echo e(number_format(Auth::user()->walletbalance)); ?></span></h4>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="text-nowrap">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn btn-soft-success waves-effect waves-light btn-rounded">
                                    <i class="bx bx-transfer-alt label-icon"></i> Withdraw Funds to External Crypto wallet
                                </button>
                                ...
                                <br />
                                <br />
                                <button type="button" data-bs-toggle="modal" data-bs-target="#staticBank" class="btn btn-soft-success waves-effect waves-light btn-rounded">
                                    <i class="bx bx-transfer-alt label-icon"></i> Withdraw Funds to Bank Account
                                </button>
                                ...
                                <!-- Crypto Withdrawal Modal (Express) -->
                                 <div class="modal fade" id="staticBackdropexpress" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                 <div class="modal-dialog modal-dialog-centered" role="document">
                                     <div class="modal-content">
                                         <form action="<?php echo e(route('withdrawal.store')); ?>" method="post">
                                             <?php echo csrf_field(); ?>
                                             <div class="modal-header">
                                                 <h5 class="modal-title" id="staticBackdropLabel">Withdraw Funds (Express)</h5>
                                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                             </div>
                                             <div class="modal-body">
                                                 <div class="col-lg-12">
                             ...
                             <!-- end modal -->
                                ...
                                <div class="modal fade" id="staticBank" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <form action="<?php echo e(route('withdraw_bank')); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                                <div class="modal-header">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <h4 class="mb-3">$<span><?php echo e(number_format(Auth::user()->refbonus)); ?></span></h4>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="text-nowrap">
                                ...
                                <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop2" class="btn btn-soft-primary waves-effect waves-light btn-rounded" disabled>
                                    <i class="bx bx-transfer-alt label-icon"></i> Withdraw Funds
                                </button>
                                <br />
                                        ...
                                        <table id="datatable" class="table nowrap w-100">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Estimated Time of Arival (ETA)</th>
                                                    <th>Status</th>
                                                    <th>update</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <?php if ($withdrawal->status == 'confirmed') { $buttonClass = 'btn btn-sm btn-rounded btn-outline-success'; $buttonText = 'View'; } else { $buttonClass = 'btn btn-sm btn-rounded
                                                    btn-outline-primary'; $buttonText = 'Attach Proof'; } ?>
                                                    <td style="font-size: 16px;" class="font-w400"><?php echo e($withdrawal->id); ?></td>
                                                    <td style="font-size: 16px;" class="font-w400"><?php echo e($withdrawal->dateadd->format('F j, Y g:i A')); ?></td>
                                                    <td style="font-size: 16px;" class="font-w400">$<?php echo e(number_format($withdrawal->amount)); ?></td>
                                                    <td style="font-size: 16px;" class="font-w400"><?php echo e($withdrawal->method); ?></td>
                                                    <td style="font-size: 16px;" class="font-w400"><?php echo e($withdrawal->ptype); ?></td>
                                                    <td style="font-size: 16px;" class="font-w400"><?php echo e($withdrawal->transid); ?></td>
                                                    <td style="font-size: 16px;" class="font-w400"> <?php echo e($withdrawal->ETA); ?> </td>
                                                    ...
                                                    <td><a href="<?php echo e($route); ?>" class="btn btn-rounded btn-primary"><?php echo e($buttonText); ?></a></td>

                                                    
                                                   

                                                    <td><a href="<?php echo e(route('use_express', ['id' => $withdrawal->id])); ?>" class="btn btn-rounded btn-primary">Express</a></td>
                        ...
                        <div class="card-body px-0">
                            <div class="px-3" data-simplebar style="max-height: 352px;">
                                <ul class="list-unstyled activity-wid mb-0">
                                    <?php $__currentLoopData = $completed_withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $completed_withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="timeline-list-item">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 overflow-hidden me-4">
                                                    <h5 class="font-size-14 mb-1">Transaction ID - <?php echo e($completed_withdrawal->transid); ?></h5>
                                                </div>
                                                <div class="flex-shrink-0 text-end me-3">
                                                    <h6 class="mb-1">Withdraw: <span class="text-success"> $<?php echo e(number_format($completed_withdrawal->amount)); ?> </span></h6>
                                                    <div class="font-size-13">Coin: <?php echo e($completed_withdrawal->ptype); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
...
<?php echo $__env->make('Userview.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u146041311/domains/global-digitalpulse.com/public_html/userdashboard/resources/views/Userview/withdrawal.blade.php ENDPATH**/ ?>