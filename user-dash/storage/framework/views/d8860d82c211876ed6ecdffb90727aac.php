             ...
             <div class="col-xl-6 col-sm-6 ">
                <div class="card card-coin">
                   <div class="card-body text-center">
                      ...
                      <h2 class="text-white mb-2 font-w600">$ <?php echo e(number_format(Auth::user()->refbonus)); ?> 
                      ...
                      <div class="row">
                        <div class="col-md-8">
                            <input type="text" id="myInput" class="form-control" value="<?php echo e('https://users.esxcapitalgrowth.com/register' . '?ref=' . Auth::user()->referral_code); ?>" readonly>
                        </div>
                        <div class="col-md-4">
                               ...
                               <table id="datatable" class="table nowrap w-100">
                                  ...
                                  <tbody>
                                    <?php $__currentLoopData = $referrals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $referral): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <td style="font-size: 16px;" class="font-w400 "><?php echo e($referral->fullname); ?></td>
                                       <td style="font-size: 16px;" class="font-w400 "><?php echo e($referral->email); ?></td>

                                       <td style="font-size: 16px;" class="font-w400 "><?php echo e($referral->created_at); ?></td>
...
<?php echo $__env->make('Userview.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u146041311/domains/global-digitalpulse.com/public_html/userdashboard/resources/views/Userview/referral.blade.php ENDPATH**/ ?>